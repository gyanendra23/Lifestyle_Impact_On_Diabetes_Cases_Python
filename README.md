Impact of Lifestyle on Diabetes – Complete Data Analytics & Machine Learning Project
...
✔ Machine Learning modeling (LR, RF, XGBoost)
...
Prediabetes is 6–8× higher than Type 2 Diabetes across all regions

USA, China, India → top 3 global hotspots
...
25–30% population overweight/obese
...
Highest risk in 51–75 g/day group

Physical Activity

Low/Moderate activity → highest diabetes burden

High activity → Protective effect

Diet Type

Plant-based (Vegetarian, Vegan, Pescatarian) → lowest risk

Omnivores → highest diabetes levels
...
Prediabetes is drastically higher than Type 2 → early-stage risk globally

BMI, calories, sugar & activity are strongest lifestyle predictors

Urban population faces much higher metabolic burden

Age 31–60 most vulnerable

Underweight groups also show elevated glucose → genetic or poor nutrition factors
